...
/**
 * Phpfreaks\SiteBundle\Entity\Tag
 *
 * @ORM\Entity
 * @ORM\Table(name="tags")
 * @ORM\Entity(repositoryClass="Phpfreaks\SiteBundle\Entity\TagRepository")
 */
class Tag
{
     ...
     * @var $title
     *
     * @Assert\NotBlank(message="You cannot leave the tag title blank")
     * @Assert\NotNull(message="You cannot leave the tag title null")
